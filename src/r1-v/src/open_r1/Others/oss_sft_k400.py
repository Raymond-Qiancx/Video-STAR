...
def prepare_dataset(example: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    # 定义动作解释文件路径
    json_file_path = "/mnt/xmap_nas_alg/yzl/Recognition/AFile/json/kinetics400/train_rephrased.json"
            ...
            "content": [
                {
                    ...
                    example['data_type']: os.path.join("/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/kinetics400/videos_train_2/compress/val", example['path'])
                },
                {
                    "type": "text",
            ...
            "content": [
                ...
                },
                {
                    ...
                    "text": SECOND_TURN_TEMPLATE.format(
                        ...
                        ANNOTATED_VIDEO_PATH=os.path.join("/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/kinetics400/videos_train_2/compress/val_pose", example['path'])
                    )
                }
            ]
        },
