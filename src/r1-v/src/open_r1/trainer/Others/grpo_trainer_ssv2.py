...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if inputs[0]['data_type'] == 'image':
            input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/SSv2/20bn-something-something-v2/" + inputs[0]['path']
        elif inputs[0]['data_type'] == 'video':
            input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/SSv2/20bn-something-something-v2/" + inputs[0]['path']
        ...
        try:
            ...
            if inputs[0]['data_type'] == 'image':
                input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/SSv2/20bn-something-something-v2/" + 'Math/Multimath-300k/17ff4c7d14c388134de02381b1fc2824.png'
            elif inputs[0]['data_type'] == 'video':
                input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/SSv2/20bn-something-something-v2/" + 'LLaVA-Video-178K/liwei_youtube_videos/videos/youtube_video_2024/ytb_7nRmsEw7nsE.mp4'
            first_turn_image_inputs, first_turn_video_inputs, first_turn_video_kwargs = process_vision_info(input_copy, return_video_kwargs=True)
        ...
        def get_video_path(x_path, pose_estimation, person_detection, original_video_path="/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/SSv2/20bn-something-something-v2"):
            """根据工具决策选择对应的视频路径"""
            if pose_estimation == 'yes' and person_detection == 'no':
                base_path = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/po"
                return os.path.join(base_path, x_path)
            elif pose_estimation == 'yes' and person_detection == 'yes':
                base_path = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/pose"
                return os.path.join(base_path, x_path)
            elif pose_estimation == 'no' and person_detection == 'yes':
                base_path = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/bound"
                return os.path.join(base_path, x_path)
            else:
        ...
        for i, (first_turn_completion, input_data) in enumerate(zip(first_turn_completions, inputs)):
            ...
            # 构建注释视频路径
            annotated_video_path = os.path.join("/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/SSv2/pose", input_data['path'])
