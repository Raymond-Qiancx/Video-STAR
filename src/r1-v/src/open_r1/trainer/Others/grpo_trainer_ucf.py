...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if inputs[0]['data_type'] == 'image':
            input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/ucf101/UCF-101/" + inputs[0]['path']
        elif inputs[0]['data_type'] == 'video':
            input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/ucf101/UCF-101/" + inputs[0]['path']
        ...
        try:
            ...
            if inputs[0]['data_type'] == 'image':
                input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/ucf101/UCF-101/" + 'Math/Multimath-300k/17ff4c7d14c388134de02381b1fc2824.png'
            elif inputs[0]['data_type'] == 'video':
                input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/ucf101/UCF-101/" + 'LLaVA-Video-178K/liwei_youtube_videos/videos/youtube_video_2024/ytb_7nRmsEw7nsE.mp4'
            first_turn_image_inputs, first_turn_video_inputs, first_turn_video_kwargs = process_vision_info(input_copy, return_video_kwargs=True)
        ...
        for i, (first_turn_completion, input_data) in enumerate(zip(first_turn_completions, inputs)):
            ...
            # 构建注释视频路径
            annotated_video_path = os.path.join("/mnt/xmap_nas_alg/yzl/Recognition/mmaction2/data/ucf101/UCF-101_pose", input_data['path'])
